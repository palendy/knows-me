...
> 이 문서는 프로젝트의 **왜**와 설계 원칙을 담은 원문이다. 빌드·사용법은 [`../README.md`](../README.md), [`build.md`](build.md), [`usage.md`](usage.md)를 본다.

![knows-me 데모](demo.gif)
...
연결하는 순서는 [`docs/collecting.md` §1](collecting.md).
...
세부 문서: 설계·유닛·진행 상태는 `aidlc-docs/`, 코어/셸 안내는 `src-tauri/README.md`·`desktop/README.md`, 수집을 직접 돌리고 진단하는 법은 [`docs/collecting.md`](collecting.md), 팀 공유 안내는 `docs/team-sharing.md`, 데모 영상 각본은 [`docs/demo/`](demo/).
