...
- [x] `nfr-requirements/nfr-requirements.md` — U2 관점 성능/신뢰성/보안·프라이버시/오프라인/유지보수 NFR
- [x] `nfr-requirements/tech-stack-decisions.md` — Rust crate 선정(HTTP·직렬화·파일감시·PDF/DOCX·PBT 프레임워크) + 근거
- [x] PBT-09: PBT 프레임워크 선정·문서화(Rust=proptest; TS는 대상 코드 없어 N/A) — dev-dependency 명시
